...
function buildimagePath(string $name = null , string $type)
{
    if ($type === 'user' && !isset($name)){
        return 'Views/img/icon-default-user.svg';
    }

    return 'Views/img_uploaded/' . $type . '/' . htmlspecialchars($name);
}
                        ...
                        <div class="icon-list">
                            <div class="like">
                                ...
                                if (isset($view_tweet['like_id'])) {
                                    echo '<img src="Views/img/icon-heart-twitterblue.svg" alt="">';
                                } else {
                                    
                                echo '<img src="Views/img/icon-heart.svg" alt="">';
                                }
                                ?>
                            </div>
